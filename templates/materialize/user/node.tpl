													...
													<ul class="nav nav-list margin-no pull-left">
														<li class="dropdown">
															...
															<ul class="dropdown-menu">
																<li>
																    <a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">location_on</i>&nbsp;服务器地址：<{$row['node_server']}></a>
																</li>
																<li>
																    <a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">lock_outline</i>&nbsp;端口：<{$row['port']}></a>
																</li>
																<li>
																    <a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">security</i>&nbsp;密码：<{$oo->get_pass()}></a>
																</li>
															</ul>
														</li>
													</ul>
													...
													<div class="card-action">
														<ul class="nav nav-list margin-no pull-left">
															<li class="dropdown">
																...
																<ul class="dropdown-menu">
																	<li>
																		<a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">location_on</i>&nbsp;服务器地址：<i class="icon icon-lg">visibility_off</i></a>
																	</li>
																	<li>
																		<a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">lock_outline</i>&nbsp;端口：<i class="icon icon-lg">visibility_off</i></a>
																	</li>
																	<li>
																    <a class="waves-attach" href="javascript:void(0)"><i class="icon icon-lg">security</i>&nbsp;密码<i class="icon icon-lg">visibility_off</i></a>
																    </li>
																</ul>
															</li>
														</ul>
...
<div aria-hidden="true" class="modal modal-va-middle fade" id="node_qr" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-xs">
		<div class="modal-content">
			...
			<div class="text-center">
				<p><a href="" target="_blank" class="ssrlink">点击添加配置文件（需客户端支持）</a></p>
			</div>
			</hr>
